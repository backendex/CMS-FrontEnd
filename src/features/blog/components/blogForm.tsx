    ...
    <form onSubmit={handleSubmit} className="space-y-8 p-6 max-w-5xl mx-auto">
      ...
      <Card className="border-none shadow-none bg-transparent">
        <CardContent className="p-0 space-y-4">
          <Input
            className="text-4xl font-bold h-auto py-4 border-none shadow-none focus-visible:ring-0 placeholder:opacity-50 bg-transparent"
            placeholder="Añadir el título"
            value={post.postTitle || ""}
            onChange={(e) => setPost({ ...post, postTitle: e.target.value })}
          />

          <div className="text-sm text-muted-foreground px-3 mb-4">
              ...
              <div className="grid gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleSeoChange("focusKeyword", e.target.value)
                    }
                  />
                </div>
            ...
            <TabsContent value="social" className="p-6">
              <div className="space-y-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setPost({ ...post, postMimeType: e.target.value })
                  }
                />
              </div>
            </TabsContent>
